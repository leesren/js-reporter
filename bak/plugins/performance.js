!function(e, t) {
	"object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.wpkperformancePlugin = t() : e.wpkperformancePlugin = t()
}(this, function() {
	return function(e) {
			var t = {};
			function n(o) {
					...
					var o, r = n(0).env, i = n(0).category, a = ["navigationStart", "unloadEventStart", "unloadEventEnd", "redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "secureConnectionStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd", "msFirstPaint"], d = ["navigate", "reload", "back_forward"], p = function(e) {
							...
							if (1 === e._ver) {
									...
									if (window.chrome && window.chrome.loadTimes)
											...
											o = e.msFirstPaint ? e.msFirstPaint : e[a[13]];
									if (!o)
											return -1;
							...
							e.env === r.BROWSER && o && o.timing) {
									...
									if (a.enable) {
											...
											u = function() {
													/loaded|complete/.test(document.readyState) && setTimeout(function() {
															...
															var r = e.toolKit.extend(t, function(e) {
																	var t, n = o.navigation || {}, r = -1, i = -1, a = -1;
																	return 1 === e._ver ? t = d[n.type] || "other" : 2 === e._ver && (r = e.encodedBodySize,
																	i = e.decodedBodySize,
																	a = e.transferSize,
																	t = e.type),
																	{
											...
											,
											f.addEventListener ? f.addEventListener(s, u, l || !1) : f.attachEvent("on" + s, u)
									} else
											e.logger.info("wpkperformancePlugin已关闭")
							} else
									e.logger.warn("基础性能插件仅支持浏览器环境")
					};
					f.prototype.pluginId = "perf",
					e.exports = f
			}
	})
});
